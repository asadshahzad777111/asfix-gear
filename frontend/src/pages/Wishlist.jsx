        ...
        <div className="container pc-wishlist">
          <AnimatePresence mode="wait" initial={false}>
            {loading ? (
              <motion.p
                key="wl-loading"
                className="section-subtitle wl-loading"
              ...
              <motion.div
                key="wl-empty"
                className="pc-wishlist-empty"
                initial={reduceMotion ? false : emptyStateVariants.initial}
                animate={emptyStateVariants.animate}
                exit={emptyStateVariants.initial}
                ...
                <div className="pc-wishlist-grid">
                  <AnimatePresence initial={false}>
                    {products.map((p, index) => {
                      ...
                      const { main } = getProductDetailImages(p);
                      ...
                      return (
                        <motion.article
                          key={p.id}
                          layout={!reduceMotion}
                          className="pc-wishlist-card"
                          initial={reduceMotion ? false : listItemVariants.initial}
                        ...
                        >
                          ...
                          <div className="pc-wishlist-card-body">
                            ...
                            <p className={`wl-stock wl-stock--${stockStatus}`}>
                              {stockStatus === 'out'
                                ? t('wishlist.stockOut')
                                : stockStatus === 'low'
