  ...
  useEffect(() => {
    ...
    const handler = (e) => {
      const target = e.target.closest(
        '.btn, .filter-btn, .fab-add, .nav-add-product, .category-chip, .discount-preset, .btn-gaming-primary, .btn-gaming-outline, .product-wa-btn, .gaming-product-order, .whatsapp-float, .chat-fab-trigger, .chat-sideboard__tab, .nav-links a'
      );
