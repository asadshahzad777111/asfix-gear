 ...
 * Sun/moon icon lives inside the thumb so the state is always obvious.
 */
    ...
    >
      <span className="theme-switch-track" aria-hidden="true">
        <span className="theme-switch-thumb">
          {isDark ? (
            <svg className="theme-switch-thumb-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path
